...
function wifi(){
    ...
    <div class="max2">
        <input id="network" class="cardin" placeholder="SSID" type="text">
        <input id="password" class="cardin" placeholder="*password*" type="number">
        <input id="encryption" class="cardin" placeholder="WPA/WPA2_WEP" type="text">
    </div>
</div>`;
}
